...
exports.XMLHttpRequest = function() {
  ...
  this.send = function(data) {
    ...
    if (settings.async) {
      ...
      // Vertex 0.4 and later won't accept empty data. Make sure it's needed.
      if (data) {
        request.write(data);
      }
      ...
      // Create a temporary file for communication with the other Vertex process
      var syncFile = ".node-xmlhttprequest-sync-" + process.pid;
      fs.writeFileSync(syncFile, "", "utf8");
      // The async request the other Vertex process executes
      var execString = "var http = require('http'), https = require('https'), fs = require('fs');"
        ...
        + "req.end();";
      // Start the other Vertex Process, executing this string
